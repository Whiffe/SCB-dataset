# python ava2SCB_behavior2.py --csv_path ./ava/ava_v2.2/ava_train_v2.2.csv  --frames_path ./ava/trainval_frames/ --yolo_SCB_data_path ./ava_yolo_train
# python ava2SCB_behavior2.py --csv_path ./ava/ava_v2.2/ava_val_v2.2.csv  --frames_path ./ava/trainval_frames/ --yolo_SCB_data_path ./ava_yolo_val
import os
import json
import csv
import shutil  
...
# behavior_id_SCB = [78]
# print(avaActionList[16])
# input()

# 要注意，csv中的id从1开始，而非0
# behavior_id_SCB = [11, 12, 14, 17, 79] # sit, stand, walk, carry/hold (an object), talk to (e.g., self, a person, a group)
# behavior_id_SCB = [11, 12, 14] # sit, stand, walk
# behavior_id_SCB = [79] # talk to
behavior_id_SCB = [11, 12] # sit, stand
...
def gen_yolo_SCB(yolo_SCB_data_path, train_val='train', behavior_id = -1):
    ...
    shutil.copy(original_image_path, os.path.join(yolo_SCB_data_path, "images", train_val))
    ...
    '''
    '''
    # sit, stand, walk, carry/hold , talk to  0 1 2 3 4
    # sit, stand, talk to 分别映射为 0 1 2
    if int(behavior_id) ==  11:
        yolo_behavior_id = '0'
    elif int(behavior_id) ==  12:
        yolo_behavior_id = '1'
    elif int(behavior_id) ==  14:
        yolo_behavior_id = '2'
    # elif int(behavior_id) ==  17:
    #     yolo_behavior_id = '3'
    # elif int(behavior_id) ==  79:
    #     yolo_behavior_id = '4'
   '''
    '''
    if int(behavior_id) ==  79:
        yolo_behavior_id = '0'
    '''
    if int(behavior_id) ==  11:
        yolo_behavior_id = '0'
