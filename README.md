...
| :----: | :----: | :----: | :----: | :----: |
| Student Classroom Behavior Detection based on Improved YOLOv7 | [Paper](https://link.springer.com/chapter/10.1007/978-3-031-46311-2_4) |[Baidu Netdisk dataset](https://pan.baidu.com/s/1Fv0LLrxQUG3M1qS1V0Bhkg?pwd=kjek) extraction code: kjek |[Baidu Netdisk models](https://pan.baidu.com/s/1SLxUQLETajguOZu5t3EbYg?pwd=epvk)  extraction code: epvk  | hand-raising, reading, writing |
| SCB-dataset  | [Paper](https://arxiv.org/abs/2304.02488) |  [Baidu Netdisk Dataset & Models](https://pan.baidu.com/s/1keysWqSPnVCftQqDogKb4w?pwd=SCB5) extraction code：SCB5 <br> [Baidu Netdisk Dataset & Models](https://pan.baidu.com/s/1au2D8D-ewr395FBR9XWMEA?pwd=6x99) extraction code：6x99 <br> [huggingface](https://huggingface.co/datasets/wintonYF/SCB-Dataset/tree/main) |  SCB5 is still undergoing updates, and we will update it again before mid-2025. |hand-raising, read, write, discuss, clapping, leaning on the Desk,  yawn, Using the Phone, Using the Computer, talk, bow the head, turn the head, guide, answer, On-stage interaction, blackboard-writing, student blackboard-writing, stand, teacher, Screen, Blackboard |
| ...   | ...        |...        |...        |...        |
...
<div align="center">
    ...
    <img src="https://github.com/user-attachments/assets/14a4c69e-54bb-4be8-b02f-666c6fe9307e" style="width: 70%;"/>
    <img src="https://github.com/user-attachments/assets/c468245e-da8e-4e19-ac08-80838a2799a6" style="width: 70%;"/>
...
| Multi_all Computer Vision Project 5.8k | [link](https://universe.roboflow.com/-r03hy/multi_all) | 
